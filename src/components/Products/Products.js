...
const Products = () => (
  <section css={styles} className="products" id="shop">
    ...
    <Container>
      <TrendingCard cartItem={true} price="Rs.2499" cardImg={ProductOne} />
      <TrendingCard cartItem={true} price="Rs.999" cardImg={ProductTwo} />
      <TrendingCard cartItem={true} price="Rs.3099" cardImg={ProductThree} />
      <TrendingCard cartItem={true} price="Rs.2999" cardImg={ProductFour} />
    </Container>
  </section>
);
